...
def run_init_db():
    ...
    definition = "summonerId TEXT PRIMARY KEY, summonerName TEXT, leaguePoints REAL, rank REAL, wins REAL, losses REAL, veteran REAL, inactive REAL, freshBlood REAL, hotStreak REAL, tier TEXT, request_region TEXT, queue TEXT"
    conn.execute(f"CREATE TABLE IF NOT EXISTS player_table ({definition})")

    # conn.execute(f'DROP TABLE match_table')
    definition = "match_id TEXT PRIMARY KEY"
