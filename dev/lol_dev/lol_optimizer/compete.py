...
X = df
X = X.drop(
    columns=["f1", "f2", "f3", "f4", "f5", "calculated_player_performance"], axis=1
)
...
automl = AutoML(
    ...
    explain_level=2,
    total_time_limit=96 * 3600,
)  # total time limit, set large enough to have time to compute all steps (4 days)
